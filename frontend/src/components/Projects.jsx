  ...
  const projects = [
    {
      ...
      image: `${baseUrl}img/projects/project1.png`
    },
    {
      id: 'project2',
      title: '대구어린이세상',
      ...
      image: `${baseUrl}img/projects/project2.png`
    },
    {
      id: 'project3',
      title: '도서 관리 프로그램',
      ...
      image: `${baseUrl}img/projects/project3.png`
    },
    {
      id: 'project4',
      title: '이무아',
      ...
      image: `${baseUrl}img/projects/project4.png`
    },
    {
      id: 'project5',
      title: 'TIL',
      ...
      image: `${baseUrl}img/projects/project5.png`
    },
    {
      id: 'project6',
      title: 'CI3 학습 노트',
      ...
      image: `${baseUrl}img/projects/project6.png`
    }
  ];
